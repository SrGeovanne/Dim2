...
<body>
            ...
            echo "<tr id='row-" . $row['id'] . "'>
                    ...
                    <td>
                        <select name='carga[]' onchange='atualizarFpPorCarga(this)'>
                            <option value='iluminacao com compensacao'" . ($row['Carga'] == 'iluminacao com compensacao' ? ' selected' : '') . ">Iluminação com compensação</option>
                            <option value='iluminacao sem compensacao'" . ($row['Carga'] == 'iluminacao sem compensacao' ? ' selected' : '') . ">Iluminação sem compensação</option>
                            <option value='tomada'" . ($row['Carga'] == 'tomada' ? ' selected' : '') . ">Tomada de Uso Geral</option>
                        </select>
                    </td>
    ...
    <script>
        ...
        function calcular() {
            ...
            // Ordena as linhas da tabela com base no valor do grupo
