...
<body>
    ...
    <script>
        ...
        // Calcula os dados e redireciona para a página de saída
        ...
        var url = "saida.php?dbname=<?php echo urlencode($dbname); ?>&projeto=" + encodeURIComponent(nomeProjeto) + "&" + new URLSearchParams(formData).toString();
        window.location.href = url;
    }
    </script>
</body>
